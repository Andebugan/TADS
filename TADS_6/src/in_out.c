...
{
    puts("");
    puts(YELLOW "1 - Построить ДДП (двоичное дерево поиска) по данным из файла");
    puts("2 - Построить АВЛ по данным из файла");
    puts("3 - Добавить слово в ДДП");
    puts("4 - Добавить слово в АВЛ");
    puts("5 - Вывести ДДП на экран");
    puts("6 - Вывести АВЛ на экран");
    puts("7 - Сравнить время добавления слов в АВЛ и ДДП");
    puts("0 - Выход в главное меню" RESET);
    puts("");
}
